...
export type LoginResponseKeySpecifier = ('accessToken' | 'user' | LoginResponseKeySpecifier)[];
export type LoginResponseFieldPolicy = {
	accessToken?: FieldPolicy<any> | FieldReadFunction<any>,
	user?: FieldPolicy<any> | FieldReadFunction<any>
};
export type MutationKeySpecifier = ('create' | 'createPost' | 'createUser' | 'login' | 'removePost' | 'removeUser' | 'updatePost' | 'updateUser' | MutationKeySpecifier)[];
...
export type PostKeySpecifier = ('authorId' | 'claps' | 'content' | 'createdAt' | 'postId' | 'published' | 'title' | 'updatedAt' | PostKeySpecifier)[];
...
export type PostResponseEdgeKeySpecifier = ('cursor' | 'node' | PostResponseEdgeKeySpecifier)[];
export type PostResponseEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
export type QueryKeySpecifier = ('hello' | 'post' | 'posts' | 'user' | QueryKeySpecifier)[];
...
export type UserResponseKeySpecifier = ('bio' | 'createdAt' | 'email' | 'name' | 'updatedAt' | 'userId' | UserResponseKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	PostResponseEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PostResponseEdgeKeySpecifier | (() => undefined | PostResponseEdgeKeySpecifier),
